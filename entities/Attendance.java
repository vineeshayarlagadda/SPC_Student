...
public class Attendance {
    ...
    @NotNull(message = "Attendance id cannot be null or blank")
...
//	private Student student;
    ...
    @NotNull(message = "Class date cannot be null or blank")
	@Past(message = "Class date is invalid")
    ...
    @NotNull(message = "Attendance cannot be null or blank")
